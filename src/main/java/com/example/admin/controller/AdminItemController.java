...
public class AdminItemController {
    ...
    public String searchProduct(
        ...
        // 전체 아이템 수 조회 (검색 조건 포함)
        int totalCnt = itemService.countSearchItems(searchField, searchValue, categoryName, minStock, maxStock, minPrice, maxPrice);
        AdminPageHandler pageHandler = new AdminPageHandler(totalCnt, pageSize, page);
        ...
        // 검색 결과가 비어 있는지 여부를 모델에 추가
        model.addAttribute("isEmptyResult", item.isEmpty());
